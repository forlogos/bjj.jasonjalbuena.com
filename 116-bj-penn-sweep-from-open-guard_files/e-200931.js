function st_go(a){var i,u=document.location.protocol+'//web.archive.org/web/20090731174914/http://stats.wordpress.com/g.gif?host='+escape(document.location.host)+'&rand='+Math.random();for(i in a){u=u+'&'+i+'='+escape(a[i]);}u=u+'&ref='+escape(document.referrer);document.open();document.write("<img id=\"wpstats\" src=\""+u+"\" alt=\"\" />");document.close();}
/*	The following Javascript includes code from
 *		http://web.archive.org/web/20090731174914/http://verens.com/archives/2005/03/21/tracking-external-links-with-ajax/
 *	and
 *		http://web.archive.org/web/20090731174914/http://www.xml.com/pub/a/2005/02/09/xml-http-request.html
 *	and
 *		http://web.archive.org/web/20090731174914/http://andy.wordpress.com/
 */
...
function linktracker_record(event){
	...
	var i=new Image(1,1);
	i.src=pr+'//web.archive.org/web/20090731174914/http://stats.wordpress.com/c.gif?s=2&b='+b+'&p='+p+'&u='+escape(bh);
